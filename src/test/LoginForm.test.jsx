...
describe("Testing LoginForm Component", () => {
  test("Should render title", () => {
    render(<LoginForm />);
    const title = screen.getByText(/Debe ingresar/i);
  ...
  test("Should change second input", () => {
    ...
    expect(pass.value).toBe("Contraseña123"); // verifica que un valor sea igual a otro valor. Ej: pass.value === "Contraseña123"
  });
